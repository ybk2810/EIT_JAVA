...
public class Amplitude_Calibration extends JFrame {
	...
	int m_nFreq;
	int[] m_nAmp =  new int[Definition.Fabric_SEIT_ALL_CH+1];
	FileWriter[] fout = new FileWriter[Definition.Fabric_SEIT_ALL_CH];
	int m_nAverage;
	String m_strFreq ;
				...
				try {
					Amp_Cal_fun.AmpCalSystemSetting();
					 ...
					 String FilePath;
						...
						double [] m_dFactor = new double[Definition.Fabric_SEIT_ALL_CH];
						for(int Ch = 0; Ch < Definition.Fabric_SEIT_ALL_CH; Ch++)
						{
						...
						Amp_Cal_fun.AmpCalWriteFile(Definition.Fabric_SEIT_ALL_CH,FilePath,m_dFactor);
