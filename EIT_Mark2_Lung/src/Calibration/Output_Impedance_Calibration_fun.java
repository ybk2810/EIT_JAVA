...
public class Output_Impedance_Calibration_fun {
	...
	//int[]  m_nFreq= new int[Definition.TOTAL_CH]; 
	...
	FileWriter[] foutCout = new FileWriter[Definition.TOTAL_CH];
	FileWriter[] foutRout = new FileWriter[Definition.TOTAL_CH];
	FileWriter[] foutZout = new FileWriter[Definition.TOTAL_CH];

	double[]  TempZout = new double[Definition.TOTAL_CH];
	double[] TempRout = new double[Definition.TOTAL_CH];
	double[] TempCout = new double[Definition.TOTAL_CH];
	...
	boolean CCSCalSystemSetting() throws HeadlessException, InterruptedException
	{
		...
		if(!Output_Impedance_Calibration.getEIT_Control_Dlg().EIT_Control.CommFPGASet(Output_Impedance_Calibration.getEIT_Control_Dlg().EIT_Control.m_nOpMode >> 3,0,0,Output_Impedance_Calibration.getEIT_Control_Dlg().EIT_Control.m_nTotalProjection-1))
		{
		...
		int [] Real =  new int[Definition.TOTAL_CH];
		int[] Quad =  new int[Definition.TOTAL_CH];
		if(!CCSCalProjection(Definition.TOTAL_CH,OV,Real,Quad))
		{
			return false;
		}
		return true;
	...
	boolean CCSCalProjection(int TotalCh, int[] Overflow, int[] Real, int[] Quad)
	{
		...
		for(int Ch = 0; Ch < TotalCh; Ch++)
		{
			...
			Overflow[Ch] = (Output_Impedance_Calibration.getEIT_Control_Dlg().EIT_Control.USB.m_nResponse[Ch * 6 + 1]&0xFF);
	...
	{
		int[] TempSelect1 = new int [Definition.TOTAL_CH];
		int[] TempSelect2 = new int[Definition.TOTAL_CH];
		int[] TempMin1 = new int[Definition.TOTAL_CH];
		int[] TempMax1 =  new int[Definition.TOTAL_CH];
		int[] TempMin2 = new int [Definition.TOTAL_CH];
		int[] TempMax2 = new int[Definition.TOTAL_CH];
		int TempStep1 = 0,TempStep2 = 0;
		int[] TempCoarseR = new int[Definition.TOTAL_CH];
		int[] TempFineR = new int[Definition.TOTAL_CH];
		int[] TempCoarseC = new int[Definition.TOTAL_CH];
		int[] TempFineC = new int[Definition.TOTAL_CH];
	
		double[] TempMaxZout = new double[Definition.TOTAL_CH];
		double[] TempMaxRout = new double[Definition.TOTAL_CH];
		double[] TempMaxCout = new double[Definition.TOTAL_CH];

		int[][]TempDigi1 = new int[Definition.TOTAL_CH][3];
		int[][]TempDigi2 = new int[Definition.TOTAL_CH][3];
		/*for(int i = 0; i < Definition.TOTAL_CH; i++)
		{
...
//Coarse
		Object[] Mat_DAta1 = GetOutputImpedanceMatrix(Definition.TOTAL_CH,TempSelect1,TempMax1,TempMin1,TempStep1,TempSelect2,TempMax2,TempMin2,TempStep2,TempCoarseR,TempFineR,TempCoarseC,TempFineC,TempDigi1,TempDigi2,TempMaxZout,TempMaxRout,TempMaxCout);
		...
		Object[] Mat_DAta2 = GetOutputImpedanceMatrix(Definition.TOTAL_CH,TempSelect1,TempMax1,TempMin1,TempStep1,TempSelect2,TempMax2,TempMin2,TempStep2,TempCoarseR,TempFineR,TempCoarseC,TempFineC,
...
//Fine
		Object[] Mat_DAta3 =GetOutputImpedanceMatrix(Definition.TOTAL_CH,TempSelect1,TempMax1,TempMin1,TempStep1,TempSelect2,TempMax2,TempMin2,TempStep2,TempCoarseR,TempFineR,TempCoarseC,TempFineC,
			TempDigi1,TempDigi2,TempMaxZout,TempMaxRout,TempMaxCout);
		...
		Object[] Mat_DAta4 =GetOutputImpedanceMatrix(Definition.TOTAL_CH,TempSelect1,TempMax1,TempMin1,TempStep1,TempSelect2,TempMax2,TempMin2,TempStep2,TempCoarseR,TempFineR,TempCoarseC,TempFineC,
			TempDigi1,TempDigi2,TempMaxZout,TempMaxRout,TempMaxCout);
				...
				for(int j = 0; j < Length2; j++)
					{
						...
						if(!GetSingleOutputImpedance(Definition.TOTAL_CH,TempCoarseR,TempFineR,TempCoarseC,TempFineC))  /// should return 3 matrix
						{
						return null;
						}
				
						for(int n = 0; n < Definition.TOTAL_CH; n++)  ////// from CalRout
						{
	...
	{
		int[] Overflow = new int[Definition.TOTAL_CH];
		int[] m_nRealHigh = new int[Definition.TOTAL_CH];
		int[] m_nQuadHigh = new int[Definition.TOTAL_CH];
		int[] m_nRealLow = new int[Definition.TOTAL_CH];
		int[] m_nQuadLow = new int[Definition.TOTAL_CH];
